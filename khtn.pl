...
khoa('Vat ly - Vat ly ky thuat').
truc_thuoc('Vat ly - Vat ly ky thuat', '�H KHTN').
...
% Khoa Toan Tin hoc
khoa('Toan - Tin hoc').
truc_thuoc('Toan - Tin hoc', '�H KHTN').
...
khoa('Dien tu - Vien thong').
truc_thuoc('Dien tu - Vien thong', '�H KHTN').
bo_mon('Dien tu').
...
khoa('Sinh hoc - Cong nghe sinh hoc').
truc_thuoc('Sinh hoc - Cong nghe sinh hoc', '�H KHTN').
...
khoa('Khoa hoc va Cong nghe vat lieu').
truc_thuoc('Khoa hoc va Cong nghe vat lieu', '�H KHTN').
