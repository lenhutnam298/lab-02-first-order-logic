...
truc_thuoc('CNTT', 'ÐH KHTN').

nam_thanh_lap('CNTT',1995).

phong('CNTT','I.53').
bo_mon('Khoa hoc may tinh').
phong('Khoa hoc may tinh', 'I.81').
bo_mon('Cong nghe tri thuc').
phong('Cong nghe tri thuc', 'I.63').
bo_mon('Thi giac may tinh va dieu khien hoc thong minh').
phong('Thi giac may tinh va dieu khien hoc thong minh', 'I.72').
bo_mon('He thong thong tin').
phong('He thong thong tin', 'I.84').
bo_mon('Mang may tinh va Vien thong').
phong('Mang may tinh va Vien thong', 'I.74').
bo_mon('Cong nghe phan mem').
phong('Cong nghe phan mem', 'I.82').
...
truc_thuoc('Khoa hoc may tinh', 'Khoa hoc may tinh').
chuyen_nganh('Thi giac may tinh').
truc_thuoc('Khoa hoc may tinh', 'Khoa hoc may tinh').
...
khoa('Vat ly - Vat ly ky thuat').
truc_thuoc('Vat ly - Vat ly ky thuat', 'ÐH KHTN').
...
% Khoa Toan Tin hoc
khoa('Toan - Tin hoc').
truc_thuoc('Toan - Tin hoc', 'ÐH KHTN').
...
khoa('Dien tu - Vien thong').
truc_thuoc('Dien tu - Vien thong', 'ÐH KHTN').
bo_mon('Dien tu').
...
khoa('Sinh hoc - Cong nghe sinh hoc').
truc_thuoc('Sinh hoc - Cong nghe sinh hoc', 'ÐH KHTN').
...
khoa('Khoa hoc va Cong nghe vat lieu').
truc_thuoc('Khoa hoc va Cong nghe vat lieu', 'ÐH KHTN').
...
pho_giao_lam_truong_khoa(_giangVien):-
    giang_vien(_giangVien),
